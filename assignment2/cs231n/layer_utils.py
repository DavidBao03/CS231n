...
def affine_bn_ln_relu_drop_forward(x, w, b, gamma, beta, bn_param, normalization, dropout_param):
    bn_cache, ln_cache, drop_cache = None, None, None
    a, fc_cache = affine_forward(x, w, b)
    ...
    cache = (fc_cache, bn_cache, ln_cache, relu_cache, drop_cache)
    return out, cache

def affine_bn_ln_relu_drop_backward(dout, cache):
    dgamma, dbeta = None, None
    fc_cache, bn_cache, ln_cache, relu_cache, drop_cache = cache
